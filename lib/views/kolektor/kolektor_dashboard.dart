...
class _KolektorDashboardState extends State<KolektorDashboard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<DhkpProvider>(context, listen: false).fetchDhkp(currentUser: auth.user);
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    LinearProgressIndicator(
                      value: ((summary?.persentaseCapaian ?? 0) / 100.0).clamp(0.0, 1.0),
                ...
                children: [
                  Expanded(
                    child: _buildStatBadge(
                      title: 'SPPT LUNAS',
                      value: '${dhkpProvider.items.where((e) => e.isLunas).length}',
